...
namespace ConwayGameOfLife
{
    public class ConwayGameOfLife
    {
        ...
        public ILifeBehaviour CurentBehaviour { get; set; }
        // constructor
        public ConwayGameOfLife()
        {
            ...
            InitializeLife();
            CurentBehaviour = new StandardLifeBehaviour();
        }
        ...
        public void Evolve()
        {
            ...
            for (int r = 0; r < HEIGHT; r++)
            {
                ...
                for (int c = 0; c < WIDTH; c++)
                {
                    ...
                    // cell should live?
                    this.Space[r, c] = CurentBehaviour.CellShouldLive(livingCell, neighBourCount);
                }
            }
        }
